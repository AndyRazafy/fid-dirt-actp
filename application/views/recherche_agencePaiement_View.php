  		...
  		<div class="row">
  			<div class="content-box-large">
				...
				<div class="panel-body">
					...
					<form action="<?php echo site_url('AgencePaiement_Controller/create'); ?>" method="POST" id="form">
							...
							<tbody>
								<?php 
									...
									<tr>
										...
										<td width="70%"><a href="<?php echo ''; ?>"><?php echo $row->getNom(); ?></a></td>
										<td><button type="button" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i> Modifier</button></td>
										<td>
											<button class="btn btn-danger" onclick="javascript:supprimerAgence(<?php echo "'validationSuppressionAgenceModal".$row->getId()."'"; ?>);"><i class="glyphicon glyphicon-remove"></i> Supprimer</button>
											<div class="modal fade" id="<?php echo 'validationSuppressionAgenceModal'.$row->getId(); ?>" role="dialog">
										        <div class="modal-dialog">
												<!-- Modal content-->
											        <div class="modal-content">
											            <div class="modal-header">
											            ...
											            <div class="modal-body">
											            	<h3>Voulez-vous vraiment supprimer <?php echo $row->getNom(); ?>?</h3>
											            </div>
											            <div class="modal-footer">
											                <a href="#" class="btn btn-success" onclick="javascript:validation(<?php echo '\'#formSuppressionAgence'.$row->getId().'\''; ?>);" data-dismiss="">Valider</a>
											                <button type="button" class="btn btn-default" data-dismiss="modal">Annuler</button>
											            </div>
											        </div>
											    </div>
											</div>
											<form action="<?php echo site_url('AgencePaiement_Controller/delete/'.$row->getId()); ?>" id="<?php echo 'formSuppressionAgence'.$row->getId(); ?>">	
											</form>
										</td>
									</tr>
								<?php } ?>
